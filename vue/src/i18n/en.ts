...
export const en: IIBI18nMap = {
  sizeAndRatio: 'Dimensions and aspect ratio',
  exactSizeFilter: 'Exact size',
  aspectRatioFilter: 'Aspect ratio',
  resolutionPreset: 'Resolution preset (editable)',
  imageHeight: 'Height',
  ratioWidth: 'Ratio width',
  ratioHeight: 'Ratio height',
  sizeFilterHint: 'Leave blank for any size. Ratios match width:height exactly, preserving orientation. When both filters are set, both must match.',
  sizeFilterInvalid: 'Enter both width and height as whole numbers from 1 to 1,000,000.',
  ...
  loadingTip7: '🔎 Quick filters\n\nUse size, aspect ratio or tag filters below the library search bar. Manage tags in Settings → Tag configuration.|info',
