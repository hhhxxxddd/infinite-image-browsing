export const zhHans = {
  ...
  disable: '停用',
  autoRefresh: '自动刷新',
  autoRefreshNormalFixedMode: '启用自动刷新 (逐层浏览／直接打开模式)',
  autoRefreshWalkMode: '启用自动刷新 (包含子文件夹模式)',
  autoRefreshWalkModePosLimit: '包含子文件夹模式下触发自动刷新的位置极限',
...
你可以在全局设置页面中指定启动IIB时恢复到哪一个快照，或者恢复到最后关闭前的工作区状态。`,
  ...
  shortcutPresetActionTiktokExit: '退出 单项浏览 视图',
