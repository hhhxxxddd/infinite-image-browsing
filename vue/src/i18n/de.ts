...
export const de: Partial<IIBI18nMap> = {
  sizeAndRatio: 'Abmessungen und Seitenverhältnis',
  exactSizeFilter: 'Exakte Größe',
  aspectRatioFilter: 'Seitenverhältnis',
  resolutionPreset: 'Auflösungsvorgabe (anpassbar)',
  imageHeight: 'Höhe',
  ratioWidth: 'Verhältnisbreite',
  ratioHeight: 'Verhältnishöhe',
  sizeFilterHint: 'Leer lassen für alle Größen. Verhältnisse werden exakt als Breite:Höhe geprüft. Sind beide Filter gesetzt, müssen beide zutreffen.',
  sizeFilterInvalid: 'Breite und Höhe vollständig als ganze Zahlen von 1 bis 1.000.000 eingeben.',
  ...
  loadingTip7: '🔎 Schnellfilter\n\nFiltern Sie unter der Mediensuche nach Größe, Seitenverhältnis oder Tags. Tags verwalten Sie unter Einstellungen → Tag-Konfiguration.|info',
