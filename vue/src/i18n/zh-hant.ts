...
export const zhHant: Partial<IIBI18nMap> = {
  ...
  disable: '停用',
  autoRefresh: '自動刷新',
  autoRefreshNormalFixedMode: '啟用自動刷新 (逐層瀏覽／直接開啟模式)',
  autoRefreshWalkMode: '啟用自動刷新 (包含子資料夾模式)',
  autoRefreshWalkModePosLimit: '包含子資料夾模式下觸發自動刷新的位置極限',
...
你可以在全局設置頁面中指定啟動IIB時恢復到哪一個快照，或者恢復到最後關閉前的工作區狀態。`,
  ...
  shortcutPresetActionTiktokExit: '退出 單項瀏覽 視圖',
