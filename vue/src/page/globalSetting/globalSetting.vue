...
.settings-navigation { display:flex; gap:22px; width:100%;max-width:1100px;min-width:0;box-sizing:border-box;overflow-x:auto;scrollbar-width:none;margin:0 0 18px;padding:0 2px;border-bottom:1px solid var(--ui-border); button { flex:none;padding:10px 2px 12px;border:0;border-bottom:2px solid transparent;background:transparent;color:var(--zp-secondary);font:inherit;font-size:13px;white-space:nowrap;cursor:pointer;&:hover { color:var(--ui-text); }&.active { color:var(--primary-color);border-bottom-color:var(--primary-color);font-weight:650; }&:focus-visible { outline:2px solid var(--primary-color);outline-offset:-3px; } } }
